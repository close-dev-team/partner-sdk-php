...
class SetChatConfigTest extends EndpointTestCase
{
    /** @test */
    public function post_the_items_to_the_chat_config_endpoint()
    {
        ...
        $this->givenSdk()->flowConfig()->setChatConfig($eventId, $chatId, [
