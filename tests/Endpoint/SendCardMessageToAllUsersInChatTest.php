...
class SendCardMessageToAllUsersInChatTest extends EndpointTestCase
{
    /** @test * */
    public function it_can_send_a_card_message_to_all_events()
    {
        ...
        $this->mockClient
            ->on(
                new RequestMatcher('events/'.$eventId. '/chats/'.$chatId.'/messages/card'),
        ...
        $this->givenSdk()->cardMessage()->sendToAllUsersForChat(
            $eventId,
            $chatId,
            $body
        );
