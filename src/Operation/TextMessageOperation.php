...
{
    public function sendToAllChatsForEvent(EventId $eventId, string $text, ?bool $sendPush = null): void
    {
        $this->sdk
            ->getHttpClient()
            ->post(
                ...
                RequestBodyMediator::convertStreamFromArray(
                    $this->sdk,
                    SendMessageMapper::withText($text, $sendPush)
                )
            );
    }

    public function sendToAllUsersForChat(EventId $eventId, ChatId $chatId, string $text, ?bool $sendPush = null): void
    {
        $this->sdk
            ->getHttpClient()
            ->post(
    ...
    public function sendToUserInChat(EventId $eventId, ChatId $chatId, UserId $userId, string $text, ?bool $sendPush = null): void
    {
        $this->sdk
            ->getHttpClient()
            ->post(
    ...
    public function sendToUserInAllChats(EventId $eventId, UserId $userId, string $text, ?bool $sendPush = null): void
    {
        $this->sdk
            ->getHttpClient()
            ->post(
